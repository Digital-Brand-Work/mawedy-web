...
@NgModule({
	declarations: [...components, DashboardAppointmentFilterComponent, DashboardAppointmentAddComponent, DashboardAppointmentDetailsComponent, DashboardAppointmentConfirmCancelAppointmentComponent, DashboardAppointmentConfirmReassignSlotComponent, DashboardAppointmentAssignSlotComponent, WaitingPatientsComponent, WaitingPatientsTableComponent, WaitingPatientsToolbarComponent, WaitingPatientsFilterComponent],
